...
void Widget::init()
{
    ...
    ui->friendList->setStyleSheet(*stylesheetFriendList);
    ...
    profilePicture->setStyleSheet(*stylesheetProfile);
...
#ifndef Q_OS_MAC
    ui->statusHead->setStyleSheet(*stylesheetStatusPanel);
#endif
    ...
    ui->statusPanel->setStyleSheet(*stylesheetStatusPanel);
