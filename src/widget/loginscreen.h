...
public slots:
    void onProfileLoaded(bool success);
    void onAutoLoginChanged(bool state);

private slots:
    void autoLoginToggled(int state); // From checkbox to loginScreen
...
private:
    void reset(QString initialProfileName = QString());
    void retranslateUi();
