    ...
    , micState{ToolButtonState::Disabled}
{
    ...
    micButton = createButton("micButton", this, &ChatFormHeader::micMuteToggle, *stylesheet.get());
    volButton = createButton("volButton", this, &ChatFormHeader::volMuteToggle, *stylesheet.get());
    callButton = createButton("callButton", this, &ChatFormHeader::callTriggered, *stylesheet.get());
    videoButton = createButton("videoButton", this, &ChatFormHeader::videoCallTriggered, *stylesheet.get());
