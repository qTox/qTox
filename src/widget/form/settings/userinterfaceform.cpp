 ...
 *
 * Form should contains a controllers, which change UI appearance or behaviour
 * also contains a smiles configurations.
 */
 ...
 *
 * Constructor of UserInterfaceForm. Loads controllers setup.
 */
