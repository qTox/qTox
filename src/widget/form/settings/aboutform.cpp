 ...
 * links and licence text. While update show progress.
 */
 ...
 *
 * Update commit hash if builded with git, show author and known issues info
 * It also update qtox, toxcore, Qt verstions.
 */
...
/**
 * @brief Update inforamtion about update.
 */
