...
public:
    ...
    ChatMessage::Ptr addMessage(const ToxKey& author, const QString &message, bool isAction, const QDateTime &datetime, bool isSent);
    ...
    void addAlertMessage(const ToxKey& author, QString message, QDateTime datetime);
    bool isEmpty();
...
protected:
    ...
    QString resolveToxId(const ToxKey &id);
