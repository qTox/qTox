...
signals:
    ...
    void messageNotFoundShow(const SearchDirection& direction);
...
protected:
    ...
    bool searchInText(const QString& phrase, const ParameterSearch& parameter, const SearchDirection& direction);
    std::pair<int, int> indexForSearchInLine(const QString& txt, const QString& phrase, const ParameterSearch& parameter, const SearchDirection& direction);
