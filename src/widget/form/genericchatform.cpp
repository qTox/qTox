    ...
    , stylesheetChatHead{Style::getStylesheet(":/ui/chatArea/chatHead.css")}
{
    ...
    sendButton = createButton("sendButton", this, &GenericChatForm::onSendTriggered, *stylesheetButton.get());
    emoteButton = createButton("emoteButton", this, &GenericChatForm::onEmoteButtonClicked, *stylesheetButton.get());

    fileButton = createButton("fileButton", this, &GenericChatForm::onAttachClicked, *stylesheetButton.get());
    screenshotButton = createButton("screenshotButton", this, &GenericChatForm::onScreenshotClicked, *stylesheetButton.get());
    ...
    msgEdit->setStyleSheet(*stylesheetMsgEdit.get() + fontToCss(Settings::getInstance().getChatMessageFont(), "QTextEdit"));
    ...
    chatWidget->setStyleSheet(*stylesheetChatArea.get());
    headWidget->setStyleSheet(*stylesheetChatHead.get());
...
void GenericChatForm::onChatMessageFontChanged(const QFont& font)
{
    ...
    msgEdit->setStyleSheet(*newStyle.get() + fontToCss(font, "QTextEdit"));
