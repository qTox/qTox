...
private slots:
    ...
    void onCallClicked();
    void onUserJoined(const GroupId& groupId, const ToxPk& user, const QString& name);
    void onUserLeft(const GroupId& groupId, const ToxPk user, const QString& name);
    void onPeerNameChanged(const GroupId& groupId, const ToxPk peer, const QString& oldName, const QString& newName);
...
private:
    void retranslateUi();
    void updateUserCount(const GroupId& groupId, int numPeers);
