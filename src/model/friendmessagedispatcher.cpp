 ...
 * @param[out] receipt
 */
bool sendMessageToCore(ICoreFriendMessageSender& messageSender, Friend const* f,
                       Message const& message, ReceiptNum& receipt)
{
...
/**
 * @brief See IMessageSender::sendMessage
 */
