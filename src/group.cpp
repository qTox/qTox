...
{
    ToxKey peerKey = Core::getInstance()->getGroupPeerKey(groupId, peerId);
...
void Group::regeneratePeerList()
{
    ...
    {
        ToxKey id = core->getGroupPeerKey(groupId, i);
        ToxKey self = core->getSelfId().getPublicKey();
        if (id == self)
            selfPeerNum = i;
...
QString Group::resolveToxId(const ToxKey &id) const
{
