...
ToxFriendCall::ToxFriendCall(ToxFriendCall&& other) noexcept : ToxCall(move(other)),
                                                               state{other.state},
                                                               timeoutTimer{other.timeoutTimer}
{
	other.state = TOXAV_FRIEND_CALL_STATE_NONE;
...
ToxGroupCall::ToxGroupCall(ToxGroupCall&& other) noexcept : ToxCall(move(other)), peers{other.peers}
{
