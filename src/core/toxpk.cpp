...
/**
 * @brief Constructs a ToxPk from bytes.
 * @param rawId The bytes to construct the ToxPk from.
 * @param len Number of bytes to read. Must be exactly TOX_PUBLIC_KEY_SIZE, else the ToxPk will be empty.
 */
ToxPk::ToxPk(const uint8_t *rawId, int len)
{
