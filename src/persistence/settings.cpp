...
QString Settings::getAutoAcceptDir(const ToxKey& id) const
{
    QMutexLocker locker{&bigLock};
...
void Settings::setAutoAcceptDir(const ToxKey &id, const QString& dir)
{
    QMutexLocker locker{&bigLock};
...
Settings::AutoAcceptCallFlags Settings::getAutoAcceptCall(const ToxKey &id) const
{
    QMutexLocker locker{&bigLock};
...
void Settings::setAutoAcceptCall(const ToxKey& id, AutoAcceptCallFlags accept)
{
    QMutexLocker locker{&bigLock};
...
QString Settings::getContactNote(const ToxKey &id) const
{
    QMutexLocker locker{&bigLock};
...
void Settings::setContactNote(const ToxKey &id, const QString& note)
{
    QMutexLocker locker{&bigLock};
...
QString Settings::getFriendAlias(const ToxKey& id) const
{
    QMutexLocker locker{&bigLock};
    auto it = friendLst.find(id.getKey());
    if (it != friendLst.end())
...
void Settings::setFriendAlias(const ToxKey& id, const QString& alias)
{
    QMutexLocker locker{&bigLock};
    auto it = friendLst.find(id.getKey());
    if (it != friendLst.end())
...
int Settings::getFriendCircleID(const ToxKey& id) const
{
    auto it = friendLst.find(id.getKey());
    if (it != friendLst.end())
        return it->circleID;
...
void Settings::setFriendCircleID(const ToxKey& id, int circleID)
{
    auto it = friendLst.find(id.getKey());
    if (it != friendLst.end())
    {
...
QDate Settings::getFriendActivity(const ToxKey& id) const
{
    auto it = friendLst.find(id.getKey());
    if (it != friendLst.end())
        return it->activity;
...
void Settings::setFriendActivity(const ToxKey& id, const QDate& activity)
{
    auto it = friendLst.find(id.getKey());
    if (it != friendLst.end())
    {
...
void Settings::removeFriendSettings(const ToxKey& id)
{
    QMutexLocker locker{&bigLock};
