...
void Settings::saveGlobal()
{
    ...
    QString path = paths.getLegacySettingsDirPath() + globalSettingsFile;
...
void Settings::savePersonal(QString profileName, const ToxEncrypt* passkey)
{
    ...
    QString path = paths.getLegacySettingsDirPath() + profileName + ".ini";
...
void Settings::setMakeToxPortable(bool newValue)
{
    ...
    if (newValue != makeToxPortable) {
        QFile(paths.getLegacySettingsDirPath() + globalSettingsFile).remove();
...
void Settings::createPersonal(const QString& basename) const
{
    ...
    QString path = paths.getLegacySettingsDirPath() + QDir::separator() + basename + ".ini";
...
void Settings::createSettingsDir()
{
    ...
    QString dir = paths.getLegacySettingsDirPath();
    QDir directory(dir);
