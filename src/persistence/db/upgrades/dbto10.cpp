...
bool DbTo10::dbSchema9to10(RawDatabase& db)
{
...
bool DbTo10::PeersToAuthors::peersToAuthors(RawDatabase& db, QVector<RawDatabase::Query>& upgradeQueries)
{
...
void DbTo10::PeersToAuthors::createNewTables(QVector<RawDatabase::Query>& upgradeQueries)
{
...
bool DbTo10::PeersToAuthors::populateAuthors(RawDatabase &db, QVector<RawDatabase::Query> &upgradeQueries)
{
...
bool DbTo10::PeersToAuthors::updateAliasesFk(RawDatabase &db, QVector<RawDatabase::Query>& upgradeQueries)
{
    return db.execNow(RawDatabase::Query(QStringLiteral(
...
void DbTo10::PeersToAuthors::replaceOldTables(QVector<RawDatabase::Query>& upgradeQueries) {
...
bool DbTo10::PeersToChats::peersToChats(RawDatabase& db, QVector<RawDatabase::Query>& upgradeQueries)
{
    createNewTables(upgradeQueries);
...
void DbTo10::PeersToChats::createNewTables(QVector<RawDatabase::Query>& upgradeQueries)
{
    upgradeQueries += RawDatabase::Query(QStringLiteral(
...
bool DbTo10::PeersToChats::populateChats(RawDatabase& db, QVector<RawDatabase::Query>& upgradeQueries)
{
    // don't copy over directly, so that we can convert from string to blob
    return db.execNow(RawDatabase::Query(QStringLiteral(
...
bool DbTo10::PeersToChats::updateHistoryFk(RawDatabase& db, QVector<RawDatabase::Query>& upgradeQueries)
{
    return db.execNow(RawDatabase::Query(QStringLiteral(
...
void DbTo10::PeersToChats::replaceOldTables(QVector<RawDatabase::Query>& upgradeQueries) {
    upgradeQueries += RawDatabase::Query(QStringLiteral("DROP TABLE text_messages;"));
    upgradeQueries += RawDatabase::Query(QStringLiteral("ALTER TABLE text_messages_new RENAME TO text_messages;"));
    upgradeQueries += RawDatabase::Query(QStringLiteral("DROP TABLE file_transfers;"));
    upgradeQueries += RawDatabase::Query(QStringLiteral("ALTER TABLE file_transfers_new RENAME TO file_transfers;"));
...
void DbTo10::updateTextMessagesFk(QVector<RawDatabase::Query>& upgradeQueries)
{
    upgradeQueries += RawDatabase::Query(QStringLiteral(
        "INSERT INTO text_messages_new SELECT * FROM text_messages"));
}

void DbTo10::updateFileTransfersFk(QVector<RawDatabase::Query>& upgradeQueries)
{
    upgradeQueries += RawDatabase::Query(QStringLiteral(
        "INSERT INTO file_transfers_new SELECT * FROM file_transfers"));
}

void DbTo10::PeersToChats::updateSystemMessagesFk(QVector<RawDatabase::Query>& upgradeQueries)
{
    upgradeQueries += RawDatabase::Query(QStringLiteral(
        "INSERT INTO system_messages_new SELECT * FROM system_messages"));
}

void DbTo10::PeersToChats::updateFauxOfflinePendingFk(QVector<RawDatabase::Query>& upgradeQueries)
{
    upgradeQueries += RawDatabase::Query(QStringLiteral(
        "INSERT INTO faux_offline_pending_new SELECT * FROM faux_offline_pending"));
}

void DbTo10::PeersToChats::updateBrokenMessagesFk(QVector<RawDatabase::Query>& upgradeQueries)
{
    upgradeQueries += RawDatabase::Query(QStringLiteral(
        "INSERT INTO broken_messages_new SELECT * FROM broken_messages"));
}

void DbTo10::dropPeers(QVector<RawDatabase::Query>& upgradeQueries)
{
