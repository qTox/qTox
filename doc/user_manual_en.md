...
put it in `%appdata%/roaming/tox/emoji` for Windows or `~/.config/tox/emoji`
for Linux. The emoji files have to be in a subfolder also containing
`emoticon.xml`, see the structure of https://github.com/qTox/qTox/tree/4ecbf616dcf2594cf0e65cedeb7ddc7281532c37/smileys
