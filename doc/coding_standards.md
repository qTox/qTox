...
|   4   | Tox              | Headers relating toxcore.                                                                                                    |
|   5   | Qt               | Headers for Qt objects and functions.                                                                                        |
|   6\* | External Library | Headers for any external library dependencies.                                                                               |
|   7\* | C/C++ STL        | Headers for the C/C++ standard library.                                                                                      |
|   8\* | System           | Headers specific to the operating system.                                                                                    |
...
Tox, Qt, External Library, C/C++ STL and System headers should be included with 
angle bracket (e.g. `#include <cstdint>`).
