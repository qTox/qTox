...
**This means that if you can't install sqlcipher from repositories, you'll have to compile it yourself, otherwise compiling qTox will fail.**
```bash
...
If you are not using an old version of Fedora, skip this section, and go directly to compiling
