...
const QString testStr = QStringLiteral("My Test String");
const QByteArray testByte = QByteArrayLiteral("My Test String");
const uint8_t* testUINT8 = reinterpret_cast<const uint8_t*>("My Test String");
const size_t lengthUINT8 = 14;

//"" - empty test text
const QString emptyStr = QStringLiteral("");
const QByteArray emptyByte = QByteArrayLiteral("");
const uint8_t* emptyUINT8 = reinterpret_cast<const uint8_t*>("");
const size_t emptyLength = 0;
