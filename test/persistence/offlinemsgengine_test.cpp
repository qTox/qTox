...
struct MockOfflineMsgsSettings : public IOfflineMsgsSettings
{
public:
...
public:
    OfflineMsgEngineFixture()
        ...
        , offlineMsgEngine(&f, &friendMessageSender, &offlineMsgsSettings)
    {
        ...
        offlineMsgsSettings.setFauxOfflineMessaging(true);
    }

    Friend f;
    MockFriendMessageSender friendMessageSender;
    MockOfflineMsgsSettings offlineMsgsSettings;
