...
#include "src/persistence/db/upgrades/dbto10.h"
...
void addPeers(QVector<RawDatabase::Query>& setupQueries)
{
...
void verifyChats(QVector<RawDatabase::Query>& verifyQueries)
{
...
void verifyAuthors(QVector<RawDatabase::Query>& verifyQueries)
{
    verifyQueries.append(RawDatabase::Query{QStringLiteral(
...
void addAliases(QVector<RawDatabase::Query>& setupQueries)
{
    setupQueries.append(RawDatabase::Query{QStringLiteral(
...
void verifyAliases(QVector<RawDatabase::Query>& verifyQueries)
{
    verifyQueries.append(RawDatabase::Query{QStringLiteral(
...
void addAChatMessages(QVector<RawDatabase::Query>& setupQueries)
{
    setupQueries.append(RawDatabase::Query{QStringLiteral(
...
void verifyAChatMessages(QVector<RawDatabase::Query>& verifyQueries)
{
    verifyQueries.append(RawDatabase::Query{QStringLiteral(
...
void addBChatMessages(QVector<RawDatabase::Query>& setupQueries)
{
    setupQueries.append(RawDatabase::Query{QStringLiteral(
...
void verifyBChatMessages(QVector<RawDatabase::Query>& verifyQueries)
{
    verifyQueries.append(RawDatabase::Query{QStringLiteral(
...
void addCChatMessages(QVector<RawDatabase::Query>& setupQueries)
{
    setupQueries.append(RawDatabase::Query{QStringLiteral(
...
void verifyCChatMessages(QVector<RawDatabase::Query>& verifyQueries)
{
    verifyQueries.append(RawDatabase::Query{QStringLiteral(
...
void addHistory(QVector<RawDatabase::Query>& setupQueries)
{
    addAChatMessages(setupQueries);
    addBChatMessages(setupQueries);
    addCChatMessages(setupQueries);
}

void verifyHistory(QVector<RawDatabase::Query>& verifyQueries)
{
    verifyAChatMessages(verifyQueries);
    verifyBChatMessages(verifyQueries);
    verifyCChatMessages(verifyQueries);
}
} // namespace

class Test9to10 : public QObject
{
    Q_OBJECT
private slots:
    void test9to10();
...
void Test9to10::test9to10()
{
    ...
    db->execNow(RawDatabase::Query{QStringLiteral("PRAGMA foreign_keys = ON;")});
    createSchemaAtVersion(db, DbUtility::schema9);
    QVector<RawDatabase::Query> setupQueries;
    addPeers(setupQueries);
    addAliases(setupQueries);
    addHistory(setupQueries);
    QVERIFY(db->execNow(setupQueries));
    QVERIFY(DbTo10::dbSchema9to10(*db));
    verifyDb(db, DbUtility::schema10);
    QVector<RawDatabase::Query> verifyQueries;
    verifyChats(verifyQueries);
    verifyAuthors(verifyQueries);
    verifyAliases(verifyQueries);
    verifyHistory(verifyQueries);
    QVERIFY(db->execNow(verifyQueries));
}

QTEST_GUILESS_MAIN(Test9to10)
#include "dbTo10_test.moc"
