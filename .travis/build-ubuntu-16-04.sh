...
# toxext
git clone --branch v0.0.1 --depth=1 https://github.com/toxext/toxext toxext
cd toxext
mkdir build
cd build
cmake ..
...
# toxext_messages
git clone --branch v0.0.1 --depth=1 https://github.com/toxext/tox_extension_messages tox_extension_messages
